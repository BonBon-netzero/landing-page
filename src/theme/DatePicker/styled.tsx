...
const DatePickerWrapper = styled.div`
  ...
  .react-datepicker-popper[data-placement^='top'] .react-datepicker__triangle::before,
  .react-datepicker-popper[data-placement^='bottom'] .react-datepicker__triangle::before {
    border-bottom-color: ${({ theme }) => theme.colors.neutral6};
  }
  ...
  .react-datepicker-popper[data-placement^='bottom'] .react-datepicker__triangle::after {
    border-top: none;
    border-bottom-color: ${({ theme }) => theme.colors.neutral7};
  }
  .react-datepicker-popper[data-placement^='bottom'] .react-datepicker__triangle::after {
    top: 0;
  }
  ...
  .react-datepicker-popper[data-placement^='top'] .react-datepicker__triangle::after {
    border-bottom: none;
    border-top-color: ${({ theme }) => theme.colors.neutral8};
  }
  .react-datepicker-popper[data-placement^='top'] .react-datepicker__triangle::after {
    bottom: 0;
  }
  .react-datepicker-popper[data-placement^='top'] .react-datepicker__triangle::before {
    bottom: -1px;
    border-top-color: ${({ theme }) => theme.colors.neutral6};
  }
  ...
  .react-datepicker__time-container {
    float: right;
    border-left: 1px solid ${({ theme }) => theme.colors.neutral6};
    width: 85px;
  }

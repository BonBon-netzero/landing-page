...
type Timer = { days: string; hours: string; minutes: string; seconds: string; endCountdown?: true }
...
const useCountdown = (endTime?: number) => {
  ...
  const timer = useMemo<Timer | undefined>(() => {
    ...
    if (seconds === false) return { days: '00', hours: '00', minutes: '00', seconds: '00', endCountdown: true }
